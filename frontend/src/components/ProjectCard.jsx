...
const ProjectCard = ({project}) => {
  return (
    <div>
       <div className="w-64 h-80 p-6 bg-gray-700 shadow-2xl shadow-black rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900 transition-colors duration-1000">
