    ...
    <>
      ...
      >
        <div className="grid md:grid-cols-2 py-16 gap-10">
          {/* left side */}
          <div className="w-full md:items-center md:justify-center  md:py-20 px-5 md:px-20">
            <h1 className="text-3xl md:text-3xl text-white leading-[44px] md:leading-tight font-bold md:tracking[-2px]">
              Hi, I'm{" "}
            </h1>
            <h1 className="text-5xl md:text-5xl text-amber-200 leading-[44px] md:leading-tight font-bold md:tracking[-2px]">
            ...
            <p className="text-lg md:text-lg text-white pt-2 md:pt-4 mb-8 md:mb-[11px]">
          ...
          <div className="w-full relative">
            <div className="absolute inset-0 pt-32 flex justify-center items-center">
