    ...
    <div>
      ...
      <h1 className='italic'>Dziekhey</h1>
        ...
        <div className='pt-4 decoration-white no-underline'>
          ...
          <a href='' className='no-underline text-inherit'><span className='px-4'>About</span></a>
          <a href='' className='no-underline text-inherit'><span className='px-4'>Skills</span></a>
          <a href='' className='no-underline text-inherit'><span className='px-4'>Experiences</span></a>
          <a href='' className='no-underline text-inherit'><span className='px-4'>Achievements</span></a>
          <a href='' className='no-underline text-inherit'><span className='px-4'>Projects</span></a>
